...
public abstract class Animal {
  ...
  // boolean flag that indicates if an animal has moved in the current iteration
  public bool Moved { get; protected set; }

  // the color of the animal (e.g. fish=white, shark=red)
  ...
  // specific spawning behavior of animals is implemented in the specific classes
